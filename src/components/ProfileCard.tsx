...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  const shineStyle = {
    ...
    filter: 'brightness(0.8) contrast(1.15) saturate(0.5) opacity(0.25)',
      ...
      <div ref={shellRef} className="relative z-[1] group">
        ...
        >
          ...
          >
            ...
            >
              <img
                ...
                style={{
                  ...
                  transform:
                    'translateX(calc((var(--pointer-from-left) - 0.5) * 6px)) translateZ(0) scale(calc(1 + (var(--pointer-from-top) - 0.5) * 0.01))',
                  borderRadius: cardRadius,
                  backfaceVisibility: 'hidden'
                }}
                onError={e => {
            ...
            >
              <div className="w-full absolute flex flex-col" style={{ top: 'auto', bottom: '100px', display: 'flex', gridArea: 'auto' }}>
                <h3
                  className="font-semibold m-0 text-white drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]"
                  style={{
                ...
                <p
                  className="font-semibold whitespace-nowrap mx-auto w-min text-white/90 drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]"
                  style={{
                    position: 'relative',
                    top: '-12px',
                    fontSize: '16px',
