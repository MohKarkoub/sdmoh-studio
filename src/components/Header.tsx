  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-black/60 backdrop-blur-xl border-b border-white/5">
      ...
      <div className="max-w-6xl mx-auto px-6 h-16 grid grid-cols-3 items-center">
        ...
        <span className="md:hidden text-xl bg-gradient-to-r from-orange-400 via-purple-400 to-cyan-400 bg-clip-text text-transparent font-display-alt text-center">
          SDMoh Studio
        </span>
