        ...
        <div className="p-5">
          ...
          <div className="flex flex-col gap-2">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-gradient-to-r from-orange-500 to-purple-600 text-white text-sm font-semibold transition-all duration-200 hover:from-orange-400 hover:to-purple-500 hover:shadow-lg hover:shadow-purple-500/25 active:scale-[0.97]"
            >
              Buy on Amazon
            ...
            <button
              onClick={() => onRead(book)}
              className="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl border border-white/10 text-white/70 text-sm font-medium transition-all duration-200 hover:bg-white/5 hover:border-white/20 hover:text-white"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
