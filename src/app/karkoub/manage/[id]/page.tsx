...
export default function EditBookPage() {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    const updatedBook = { id, ...form };
    const json = JSON.stringify(updatedBook, null, 2);
      ...
      <div className="relative pt-28 pb-12 px-6">
        <div className="max-w-3xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            ...
            <Link href="/karkoub/manage" className="text-white/40 hover:text-white/70 text-sm font-body transition-colors">
              &larr; Back
            </Link>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="md:col-span-2">
                ...
                <div className="mt-2 flex items-center gap-3">
                  ...
                  {form.coverImage && (
                    <button type="button" onClick={() => updateField("coverImage", "")} className="px-3 py-2 rounded-xl bg-red-500/15 border border-red-500/30 text-red-400 text-sm hover:bg-red-500/25 transition-all">
                      Delete
                    </button>
                  )}
                </div>
              ...
              <div className="flex items-center gap-3">
                  ...
                  <input type="file" accept="image/*" multiple onChange={(e) => {
                    ...
                    for (const file of files) {
                      ...
                      reader.onload = (ev) => {
                        ...
                        loaded++;
                        if (loaded === files.length) updateField("contentPages", [...form.contentPages, ...newUrls]);
                      };
                      reader.readAsDataURL(file);
                    }
                  }} className="hidden" />
                ...
                <div className="flex-1 flex gap-2">
                  ...
                  <button type="button" onClick={() => {
                    ...
                    input.value = "";
                  }} className="px-4 py-2 rounded-xl bg-white/[0.06] border border-white/20 text-white/70 text-sm hover:bg-white/[0.1] transition-all">Add</button>
                </div>
              </div>
            </div>

            <div className="flex items-center gap-3 pt-2">
              <button type="submit" className="flex-1 px-6 py-3.5 rounded-xl bg-gradient-to-r from-orange-500 to-purple-600 text-white font-semibold transition-all hover:from-orange-400 hover:to-purple-500 hover:shadow-lg hover:shadow-purple-500/25 active:scale-[0.98]">
                {copied ? "Copied!" : "Generate JSON"}
              </button>
